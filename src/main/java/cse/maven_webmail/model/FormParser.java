            ...
            while (i.hasNext()) {
                ...
                if (fi.isFormField()) {  // 5. 폼 필드 처리
                    ...
                    if (!(fi.getName() == null || fi.getName().equals(""))) {
                        ...
                        fcnt+=1;
                        if(fcnt==1){
                            setFileName1(uploadTargetDir + "/" + fi.getName());
                            File fn1 = new File(fileName1);
                            if (fileName1 != null) {
                                fi.write(fn1);
                            }
                        }
                        ...
                        {
                            setFileName2(uploadTargetDir + "/" + fi.getName());
                        ...
                        {
                            setFileName3(uploadTargetDir + "/" + fi.getName());
                        
                            File fn3 = new File(fileName3);
