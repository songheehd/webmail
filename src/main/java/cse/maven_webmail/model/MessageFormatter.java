...
public class MessageFormatter {
    ...
    public void getMessageInsertList(Message[] messages, Pop3Agent pop3Agent) {
...
//                + " </tr>");
        ...
        for (int i = messages.length - 1; i >= 0; i--) {
            ...
            pop3Agent.getMessage(msg_id);
            
            message_subject = parser.getSubject();
            message_date = parser.getSentDate();
            
            dao.update_inbox_head(userid, msg_id, message_subject, message_date);
//            
//            System.out.println("2. *****************************************");
//            System.out.println(message_subject);
